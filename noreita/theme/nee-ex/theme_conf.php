<?php
//--------------------------------------------------
// 「noReita」v2.0.0～用テーマ「nee-ex」設定ファイル
...
//テーマのバージョン
define('THEME_VER', "2.0.1 lot.251123.0");
...
//メインのテンプレートファイル
define('MAINFILE', "nee-ex_main");

//レスのテンプレートファイル
define('RESFILE', "nee-ex_res");
...
//投稿時のテンプレートファイル
define('PICFILE', "nee-ex_picpost");

//カタログ、検索モードのテンプレートファイル
define('CATALOGFILE', "nee-ex_catalog");
...
define('MISSKEYFILE', "nee-ex_misskey_note");
