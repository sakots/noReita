        ...
        <form class="ppost postform" action="{{$self}}?mode=regist" method="post" enctype="multipart/form-data">
          ...
          <table>
            <tr>
              ...
              <td><input type="text" name="name" size="28" value="{{$name_cookie}}" autocomplete="section-post username" @if ($use_name) required @endif maxlength="{{$max_name}}" data-trip-preview-input><output data-trip-preview hidden aria-live="polite"></output></td>
            </tr>
            <tr>
              <td>mail</td>
