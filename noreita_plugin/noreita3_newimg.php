<?php
//--------------------------------------------------
//  おえかきけいじばん「noReita3」の最新画像を呼び出すphp
//  by sakots & OekakiBBS reDev.Team  https://oekakibbs.moe/
//--------------------------------------------------

//  noreita3_newimg.php (c)sakots 2026 lot.260405.0
//  The MIT License

// 使い方
// noReita3のindex.phpと同じディレクトリにアップロードして
// HTMLファイルに画像を表示する時のように
// noreita3_newimg.php ←このファイルの名前をurlで指定します。

// 例）
// <img src="https://example.com/bbs/noreita3_newimg.php" alt="" width="300">
// ↑
